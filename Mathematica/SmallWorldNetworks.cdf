...
NotebookDataLength[     79124,       1569]
NotebookOptionsPosition[     52034,        987]
NotebookOutlinePosition[     78280,       1548]
CellTagsIndexPosition[     78169,       1542]
WindowTitle->Small World Networks
WindowFrame->Normal*)
        ...
        Function[{$CellContext`pts}, 
          ...
          Circle[(Part[$CellContext`pts, 1] + Part[$CellContext`pts, 2])/2, 
           Norm[Part[$CellContext`pts, 1] - Part[$CellContext`pts, 2]]/2, {
            ...
            ArcTan[Part[$CellContext`pts, 2, 1] - 
              Part[$CellContext`pts, 1, 1], Part[$CellContext`pts, 2, 2] - 
              Part[$CellContext`pts, 1, 2]]}]]}; Typeset`initDone$$ = True); 
     ReleaseHold[
       HoldComplete[{$CellContext`bezieredge = 
          Function[{$CellContext`pts, $CellContext`angle}, 
            BezierCurve[{
              Part[$CellContext`pts, 1], Part[$CellContext`pts, 2] - Dot[{{
                 Cos[$CellContext`angle], 
         ...
         Null, $CellContext`circleedge = Function[{$CellContext`pts}, 
            
            Circle[(Part[$CellContext`pts, 1] + Part[$CellContext`pts, 2])/2, 
             Norm[Part[$CellContext`pts, 1] - Part[$CellContext`pts, 2]]/2, {
              ArcTan[
              Part[$CellContext`pts, 2, 1] - Part[$CellContext`pts, 1, 1], 
               Part[$CellContext`pts, 2, 2] - Part[$CellContext`pts, 1, 2]], 
              Pi + ArcTan[
               Part[$CellContext`pts, 2, 1] - Part[$CellContext`pts, 1, 1], 
                Part[$CellContext`pts, 2, 2] - 
                Part[$CellContext`pts, 1, 2]]}]]; Null, $CellContext`network[
           Pattern[$CellContext`nodes, 
            Blank[]], 
           Pattern[$CellContext`conn, 
            Blank[]]] := Flatten[
            ...
            Table[$CellContext`i -> 
             Mod[$CellContext`i + $CellContext`j, $CellContext`nodes, 
              ...
              If[$CellContext`j >= 
               Quotient[$CellContext`nodes + 1, 2], $CellContext`nodes/
               2, $CellContext`nodes], 1}], {$CellContext`j, 
             1, $CellContext`conn - 1, 1}]], $CellContext`rewirednetwork[
           Pattern[$CellContext`p, 
            Blank[]], 
           Pattern[$CellContext`network, 
            Blank[]]] := Table[
              ...
              Cases[
               ...
               Except[
                Part[
                 ...
                 1]]]]], {$CellContext`i, 
            Part[
             Dimensions[$CellContext`network], 1]}]}]]; 
...
Cell[TextData[{
 ButtonBox["Small World Network",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/SmallWorldNetwork.html"], None},
  ButtonNote->"http://mathworld.wolfram.com/SmallWorldNetwork.html"],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
SmallWorldNetworks&version=0009"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/SmallWorldNetworks/SmallWorldNetworks-\
...
Cell[TextData[{
 "\"",
 ButtonBox["Small World Networks",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/SmallWorldNetworks/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/SmallWorldNetworks/"],
 "\"",
 " from ",
 ...
 ButtonBox["http://demonstrations.wolfram.com/SmallWorldNetworks/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/SmallWorldNetworks/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/SmallWorldNetworks/"]
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[43195, 764, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[43456, 773, 691, 15, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[51212, 962, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 77884, 1531},
 {"Copyright", 78078, 1536}
 }
*)
(*NotebookFileOutline
Notebook[{
...
Cell[34959, 592, 7987, 162, 70, "Output",
 CellID->221106652],
Cell[42949, 756, 243, 6, 70, "ManipulateCaption"],
Cell[43195, 764, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[43456, 773, 691, 15, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[44150, 790, 33, 0, 70, "DetailsSection"],
Cell[44186, 792, 43, 1, 70, "DetailNotes",
 CellID->160027340],
Cell[44232, 795, 300, 12, 70, "DetailNotes",
 CellID->451408837],
Cell[44535, 809, 44, 0, 70, "RelatedLinksSection"],
Cell[44582, 811, 645, 21, 70, "RelatedLinks",
 CellID->321869614],
Cell[45230, 834, 4793, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[50026, 925, 45, 0, 70, "CitationSection"],
Cell[50074, 927, 773, 20, 70, "Citations"],
Cell[50850, 949, 359, 11, 70, "Author"],
Cell[51212, 962, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature tQq01OXXTUUlZvA0DUSo9Zbl *)
